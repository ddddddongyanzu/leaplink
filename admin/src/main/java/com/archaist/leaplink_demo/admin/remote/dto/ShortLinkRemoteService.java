package com.archaist.leaplink_demo.admin.remote.dto;
...
import com.archaist.leaplink_demo.admin.remote.dto.req.*;
import com.archaist.leaplink_demo.admin.remote.dto.resp.*;
...
public interface ShortLinkRemoteService {
     ...
     */
    default void removeRecycleBinReqDTO(RecycleBinRemoveReqDTO requestParam) {
    ...
    default Result<IPage<ShortLinkStatsAccessRecordRespDTO>> groupShortLinkStatsAccessRecord(ShortLinkGroupStatsAccessRecordReqDTO requestParam) {
        ...
        stringObjectMap.remove("orders");
        stringObjectMap.remove("records");
        String resultBodyStr = HttpUtil.get("http://127.0.0.1:8001/api/short-link/v1/access-record/group", stringObjectMap);
        return JSON.parseObject(resultBodyStr, new TypeReference<>() {
        });
    }
}
